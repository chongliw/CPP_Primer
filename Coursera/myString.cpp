...
public:
    ...
    MyString(const MyString &rhs) : str(rhs.str) {
    ...
    MyString operator()(int i, int num) {
        auto s = str.substr(i, num).c_str();
        MyString tmp = MyString(s);
        return tmp;
    }
...
inline ostream &operator<<(ostream &os, const MyString &rhs) {
    os << rhs.str;
    return os;
}
